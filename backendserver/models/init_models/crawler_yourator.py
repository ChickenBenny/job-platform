...
class crawler_yourator():
    ...
    def get_url(self, job_type):
        url_datas = []
        url = f'https://www.yourator.co/api/v2/jobs?category[]={job_type}&tag[]=Python&sort=recent_updated'
        url_datas.append(url)
        page = 2
        while True:
            url = f'https://www.yourator.co/api/v2/jobs?category[]={job_type}&tag[]=Python&sort=recent_updated&page={page}'
    ...
    def get_data(self, url_datas):
        ...
        for url in url_datas:
            ...
            for job in job_lists:
                ...
                basic_info = container.find_all('div', {'class': 'basic-info__title'})
                ...
                tmp_data = [job_url, job_title, job_company, skill_set, job_type, job_address, salary]
...
if __name__ == '__main__':
    ...
    url_data = crawler.get_url(changer['data_engineer'])
    print(len(url_data))
